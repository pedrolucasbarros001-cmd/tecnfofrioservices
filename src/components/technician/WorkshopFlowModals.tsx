...
export function WorkshopFlowModals({ service, isOpen, onClose, onComplete }: WorkshopFlowModalsProps) {
  ...
  const ModalHeader = ({ title, step }: { title: string; step: string }) => (
    <DialogHeader className="p-0 mb-4">
      <div className="bg-orange-500 text-white px-4 py-3 rounded-lg -mx-6 -mt-6 mb-4">
        <DialogTitle className="text-lg font-bold text-white">Oficina</DialogTitle>
      ...
      <div className="flex items-center gap-2">
        <Badge className="bg-orange-100 text-orange-700 text-xs">{step}</Badge>
