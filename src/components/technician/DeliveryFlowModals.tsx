...
export function DeliveryFlowModals({ service, isOpen, onClose, onComplete }: DeliveryFlowModalsProps) {
  ...
  const ModalHeader = ({ title, step }: { title: string; step: string }) => (
    <DialogHeader className="p-0 mb-4">
      <div className="bg-green-500 text-white px-4 py-3 rounded-lg -mx-6 -mt-6 mb-4">
        <DialogTitle className="text-lg font-bold text-white">Entrega</DialogTitle>
      ...
      <div className="flex items-center gap-2">
        <Badge className="bg-green-100 text-green-700 text-xs">{step}</Badge>
