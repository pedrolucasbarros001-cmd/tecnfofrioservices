...
export function CreateDeliveryModal({ open, onOpenChange }: CreateDeliveryModalProps) {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Instruções de entrega, observações..."
                            rows={2} 
                            {...field} 
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Se definir o preço agora, a entrega aparecerá em "Em Débito".
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
